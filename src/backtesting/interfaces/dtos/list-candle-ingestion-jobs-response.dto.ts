...
class CandleIngestionJobListItemDto {
  @ApiProperty()
  readonly id: string;
...
export class ListCandleIngestionJobsResponseDto {
  @ApiProperty({ type: [CandleIngestionJobListItemDto] })
  readonly items: CandleIngestionJobListItemDto[];
